...
(4, 'Muncul Pesan eror pada BIOS (isi pesan selalu berbeda tergantung pada kondisi
tertentu)', 'G4'),
...
(10, 'Device driver informasi tidak terdeteksi dalam device manager,meski driver telah di
install', 'G10'),
(11, 'Gatal-gatal dan rontoknya bulu', 'G11'),
(12, 'Keluarnya blue screen pada OS Windows (isi pesan selalu berbeda tergantung pada
kondisi tertentu)
', 'G12'),
(13, 'Suara tetap tidak keluar meskipundriver dan setting device telah dilakukan sesuai
petunjuk', 'G13'),
(14, 'Muncul pesan error saat menjalankan aplikasi audio', 'G14'),
(15, 'Muncul pesan error saat pertama OS di load dari HDD', 'G15'),
(16, 'Tidak ada tanda-tanda dari sebagain/seluruh perangkat bekerja (semua kipas
...
(29, 'Baterai tidak mau di charge', 'G29'),
(30, 'Tidak ada indikasi masuk power', 'G30'),
(31, 'Mati total', 'G31'),
(32, 'Laptop di charge posisi hidup kemudian tiba-tiba mati layar', 'G32'),
(33, 'Keluar beep berulang-ulang kali', 'G33'),
(34, 'Belum sampai windows sudah restart lagi', 'G34'),
